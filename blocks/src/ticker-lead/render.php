...
// resolves to "LIVE" before view.js hydrates. The label strings are
// hardcoded — only the pause duration is author-controllable.
...
printf(
	'<div %1$s><a class="mh-site-mark" href="%2$s" aria-label="%3$s" title="%3$s">%4$s</a><button type="button" class="mh-ticker__live" data-wp-on--click="actions.togglePause" data-wp-text="state.label" aria-label="Pause ticker">LIVE</button></div>',
	$wrapper_attrs,
	$href,
	esc_attr( $label ),
	$svg
